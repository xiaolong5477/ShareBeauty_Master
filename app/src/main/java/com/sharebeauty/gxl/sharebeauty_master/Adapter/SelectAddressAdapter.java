...
public class SelectAddressAdapter extends RecyclerView.Adapter<SelectAddressAdapter.ViewHolder> {
    ...
    public SelectAddressAdapter(Context context, ArrayList<Integer> datas) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.select_address_item,viewGroup,false);
