...
public class ProfitAdapter extends RecyclerView.Adapter<ProfitAdapter.ViewHolder> {
    ...
    public ProfitAdapter(Context context, ArrayList<Integer> datas) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.profit_item,viewGroup,false);
