...
import com.sharebeauty.gxl.sharebeauty_master.Adapter.EquipmentAdapter;
...
public class EquipmentActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void InitView() {
        ...
        Adapter=new EquipmentAdapter(this,mDatas);
        //recycleview的点击监听
        Adapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(ViewGroup parent,View view, int position) {
                startActivity(new Intent(EquipmentActivity.this, ProjectDetailsActivity.class));
            }

            @Override
            public boolean onItemLongClick(ViewGroup parent,View view, int position) {
                T.showShort(EquipmentActivity.this,"position="+position);
                return false;
            }
        });
