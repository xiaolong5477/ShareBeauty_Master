...
public class LowerAdapter extends RecyclerView.Adapter<LowerAdapter.ViewHolder> {
    ...
    public LowerAdapter(Context context, ArrayList<Integer> datas) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lower_item,viewGroup,false);
