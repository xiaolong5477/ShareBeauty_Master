 ...
 */
public class CaseShareAdapter extends RecyclerView.Adapter<CaseShareAdapter.ViewHolder> {
    ...
    public CaseShareAdapter(Context context,ArrayList<Integer> datas) {
        this.datas = datas;
        this.context=context;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.caseshare_item,viewGroup,false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.Icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                T.showShort(context,"A_position="+position);
            }
        });
    }
