 ...
 */
public class GoodsDetailsAdapter extends RecyclerView.Adapter<GoodsDetailsAdapter.ViewHolder> {
    ...
    public GoodsDetailsAdapter(Context context, ArrayList<Integer> datas) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.goods_details_item,viewGroup,false);
