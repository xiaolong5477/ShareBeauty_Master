...
public class EquipmentAdapter extends RecyclerView.Adapter<EquipmentAdapter.ViewHolder> {
    ...
    public EquipmentAdapter(Context context,ArrayList<Integer> datas) {
        this.datas = datas;
    ...
    private void ClickEven(ViewHolder holder,final int position){
        ...
        holder.Appointment_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
        ...
        private void FindView(View view) {
            ...
            Appointment_btn= (TextView) view.findViewById(R.id.Appointment_btn);
        }
        @Override
        public void onClick(View v) {
