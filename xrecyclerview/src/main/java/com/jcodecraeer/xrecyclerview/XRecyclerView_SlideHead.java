...
public class XRecyclerView_SlideHead extends RecyclerView {
    ...
    private static final int TYPE_SLIDE_HEADER = -7;
    ...
    private View SlideHead;
    public XRecyclerView_SlideHead(Context context) {
        this(context, null);
    }

    public XRecyclerView_SlideHead(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRecyclerView_SlideHead(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setSlideHeadHeight(int height){
        SlideHeight=height;
    }
...
//            mFootViews.get(0).setVisibility(GONE);
    ...
    public int getToolViewCount(){
        return mHeaderViews.size()+mFootViews.size()+1;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e("XR","deltaY="+deltaY);
                mLastY = ev.getRawY();
                if (isOnTop() && pullRefreshEnabled&&isOnheadTop()) {
...
//                        Log.i("getVisibleHeight", " mRefreshHeader.getState() = " + mRefreshHeader.getState());
    ...
    private boolean isOnheadTop(){
        return SlideHead.getTop()==0;
    }
...
//        return false;
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount) {
                    ...
                    XRecyclerView_SlideHead.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    XRecyclerView_SlideHead.this.setVisibility(View.VISIBLE);
                }
            }
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public boolean isSlideHeader(int position) {
            return position == 0;
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            }else if(viewType == TYPE_SLIDE_HEADER){
                return new SimpleViewHolder(SlideHead=createHeader(parent));
            }
        ...
        public int getItemCount() {
            if (adapter != null) {
                return getHeadersCount() + getFootersCount() + adapter.getItemCount()+1;
            } else {
        ...
        public int getItemViewType(int position) {
            if (isSlideHeader(position)) {
                return TYPE_SLIDE_HEADER;
            }
